    ...
    <div class="row">
        <div class="col-md-4">
            <div class="bg-white">
                ...
                <div style="overflow-x: hidden" id="menu-item-list-1" class="js-left-menu-scrollbar available-items-container menu-item-list p15 pt0 text-center"><?php echo $available_items; ?></div>
            </div>
        </div>
