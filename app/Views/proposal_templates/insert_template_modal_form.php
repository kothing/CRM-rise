<div class="modal-body clearfix" id="insert-template-section">
    <div class="container-fluid">
        <div class="form-group">
            <div class="row">
                <div class="col-md-12 text-off text-danger"> <?php echo app_lang('proposal_template_inserting_instruction'); ?></div>
            </div>
        </div>

        <div class="table-responsive">
            <table id="proposal-template-table" class="display no-thead clickable" cellspacing="0" width="100%">            
            </table>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#proposal-template-table").appTable({
            source: '<?php echo_uri("proposal_templates/list_data/modal") ?>',
            order: [[0, 'desc']],
            columns: [
